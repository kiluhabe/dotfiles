...
if test -d $HOME/.local/share/omf
  ...
  set -gx NOT_FOUNDS $NOT_FOUNDS "Oh My Fish"
end
...
if test -d $HOME/.config/omf
  ...
  set -gx NOT_FOUNDS $NOT_FOUNDS "Oh My Fish Configration File"
end
...
if test -d $HOME/.rbenv
  ...
  set -gx NOT_FOUNDS $NOT_FOUNDS "rbenv"
end
...
if test -d $HOME/.pyenv
  ...
  set -gx NOT_FOUNDS $NOT_FOUNDS "pyenv"
end
...
if test -d $HOME/.nodenv
  ...
  set -gx NOT_FOUNDS $NOT_FOUNDS "nodenv"
end
...
if test -d $HOME/.tmux/plugins/
  ...
  set -gx NOT_FOUNDS $NOT_FOUNDS "tmux plugings directory"
end
...
if test -d $HOME/google-cloud-sdk/bin
  ...
  set -gx NOT_FOUNDS $NOT_FOUNDS "gcloud sdk"
end
...
if test -d $HOME/gocode
  ...
  set -gx NOT_FOUNDS $NOT_FOUNDS "gocode directory"
end
